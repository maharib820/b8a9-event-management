...
const CardShow = ({ data }) => {
    return (
        <div className="relative mb-44">
            ...
            <div className="h-[340px] absolute inset-y-1/2 inset-x-1 w-10/12 mx-auto border-2 border-yellow-600 bg-white">
                <div className="px-5 pt-7">
                    ...
                    <button className="btn bg-pink-500 text-white font-bold mt-7">Details</button>
                </div>
            </div>
        </div>
    );
